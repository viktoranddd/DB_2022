...
{
    public partial class HouseRequestForm : Form
    {
        ...
        private void HouseRequestForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                selectQueryString = "SELECT DISTINCT(Apartament.IdApartament) FROM Apartament JOIN PaymentInfo ON Apartament.IdApartament = PaymentInfo.IdApartament WHERE Apartament.IdHouse = " + s1 + " AND PIStatus = 'C'";
                sqlDataAdapter = new SqlDataAdapter(selectQueryString, sqlConnection);
                sqlCommandBuilder = new SqlCommandBuilder(sqlDataAdapter);
                dataTable = new DataTable();
                sqlDataAdapter.Fill(dataTable);
